...
_TRAIN_DATA_SOURCES = [
    ...
    #         "training-parallel-nc-v12.tgz",
     #"trg": "news-commentary-v12.fr-en.en",
     #"src": "news-commentary-v12.fr-en.de"},
    #{"url": "http://www.statmt.org/wmt13/training-parallel-commoncrawl.tgz",
    # "trg": "commoncrawl.fr-en.en",
    # "src": "commoncrawl.fr-en.fr"},
    {"url": "http://www.statmt.org/wmt13/training-parallel-europarl-v7.tgz",
     "trg": "europarl-v7.fr-en.en",
     "src": "europarl-v7.fr-en.fr"}
    ]
...
def main_wo_bpe():
    ...
    SRC = torchtext.data.Field(
        ...
        pad_token=PAD_TOK, init_token=START, eos_token=END)
    ...
    if not all([opt.data_src, opt.data_trg]):
        assert {opt.lang_src, opt.lang_trg} == {'fr', 'en'}
    else:
